...
import { BorderBottom, Facebook, Instagram, Twitter } from '@mui/icons-material';
      ...
      <Container maxWidth="lg" sx={{display:'flex'}}>
        <Grid container spacing={4} sx={{height:'100%', }}>
          <Grid item xs={12} sm={3}>
            <Link to={'/'}><img src="../../public/logo.png" alt="" width={'100%'}  style={{cursor:'pointer'}}/></Link>
            {/* <Typography variant="h6">VibeVerse</Typography> */}
          </Grid>
          <Grid item xs={12} sm={3}>
        ...
        <Box sx={{display:'flex' , flexDirection:'column', width:'43%'}}>
          <Box sx={{display:'flex' , flexDirection:'column', width:'100%', justifyContent:'center'}} >
            ...
            <Box sx={{backgroundColor:'#F0F0F0' , borderRadius:1 , display:'flex' , justifyContent:'center', alignItems:'center'}}>
              ...
              <Button sx={{height:'65%', backgroundColor:'#F0F8F0', color:'#5DAA60', border:'2px solid #5DAA60', '&:hover':{backgroundColor:'#5DAA60', color:'#F0F0F0',border:'2px solid #F0F0F0'}}} variant="contained" color="primary">JOIN</Button>
            </Box>
          </Box>
          <Box mt={2} >
